...
PTV3_EXPECTED_RELEASE_TAG="${PTV3_EXPECTED_RELEASE_TAG:-v1.5.2}"
PTV3_EXPECTED_RELEASE_COMMIT="${PTV3_EXPECTED_RELEASE_COMMIT:-ad653ee}"
PTV3_STRICT_RELEASE="${PTV3_STRICT_RELEASE:-0}"
PTV3_REPO_LAYOUT="${PTV3_REPO_LAYOUT:-auto}"
...
export COPPELIASIM_ROOT COPPELIASIM_ENV PTV3_EXPECTED_RELEASE_TAG PTV3_EXPECTED_RELEASE_COMMIT PTV3_STRICT_RELEASE PTV3_REPO_LAYOUT
